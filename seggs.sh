...
speed() {
    ...
    speed_test '35143' 'Telkomsel, ID'
    speed_test '13039' 'Indosat, ID'
    speed_test '14325' '3, ID'
    speed_test '41805' 'XL, ID'
    speed_test '12807' 'CBN, ID'
    speed_test '797' 'Biznet, ID'
    speed_test '7582' 'Telkom, ID'
    speed_test '37744' 'Telkom, SG'
    speed_test '31180' 'Campana, SG'
